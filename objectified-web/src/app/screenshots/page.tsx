...
export const metadata: Metadata = {
  title: "Screenshots - Objectified",
  description:
    "Recent captures of Objectified Studio, the public API browser, and suite previews — visual API and schema design in the product.",
};
...
const PRODUCT_SHOTS: Shot[] = [
  {
    src: "/features-01.png",
    alt: "Objectified Studio — visual schema canvas with classes, relationships, and themes",
    title: "Schema canvas",
    description:
  ...
  },
  {
    ...
    description:
      "Community and tenant-published specs at browse.objectified.dev — discover endpoints and schemas without signing in.",
        ...
        <div className="container mx-auto max-w-3xl text-center">
          <Reveal>
            ...
            <p className="mb-8 text-lg text-zinc-600 dark:text-zinc-400">
              Connect your IDE or agent host to published OpenAPI in Objectified — list, search, and pull specs without leaving the editor.
            </p>
            <Link href="/mcp">
