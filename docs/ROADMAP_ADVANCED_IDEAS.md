# Apiome Suite — Advanced Product Roadmap Ideas

This document captures potential new products for the Apiome enterprise suite. These ideas are based on analysis of the 50 existing UI mockups, the 62-table database schema, and the existing utility/conversion capabilities in `apiome-ui`. Each proposed product fills a genuine gap not covered by existing mockups and is grounded in concrete database hooks already present in the schema.

---

## 🧪 Testing & Quality

Create a mockup in the apiome-ui /mockups directory that creates a new Simulate project in /mockups/simulate as follows:
### Apiome Simulate
...
Create a mockup in the apiome-ui /mockups directory that creates a new Mark project in /mockups/mark as follows:
### Apiome Mask
...
Create a mockup in the apiome-ui /mockups directory that creates a new Lineage project in /mockups/lineage as follows:
### Apiome Lineage
...
Create a mockup in the apiome-ui /mockups directory that creates a new Topology project in /mockups/topology as follows:
### Apiome Topology
...
Create a mockup in the apiome-ui /mockups directory that creates a new Registry project in /mockups/registry as follows:
### Apiome Registry
...
Create a mockup in the apiome-ui /mockups directory that creates a new Advisor project in /mockups/advisor as follows:
### Apiome Advisor
...
Create a mockup in the apiome-ui /mockups directory that creates a new Cost project in /mockups/cost as follows:
### Apiome Cost
...
Create a mockup in the apiome-ui /mockups directory that creates a new Federate project in /mockups/federation as follows:
### Apiome Federate
...
4. **Registry** — completes the event-driven/streaming story; Avro and Protobuf converters already exist in `apiome-ui`
