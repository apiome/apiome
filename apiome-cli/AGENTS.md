...
| Emitter-registry export | `GET /v1/export/{tenant}/targets?artifact=&version=`, `POST /v1/export/{tenant}/preview` (fidelity only, no artifact; API key + tenant scope) |
