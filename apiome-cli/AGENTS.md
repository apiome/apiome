...
| `src/apiome_cli/client/export_document.py` | Emit-document client: `POST /export/document` → emitted bytes (JSON/YAML) for `export asyncapi` and future non-OpenAPI targets (MFX-11.5) |
