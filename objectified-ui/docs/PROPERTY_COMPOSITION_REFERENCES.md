...
Properties in the Objectified schema designer can now reference multiple classes using JSON Schema composition keywords: `allOf`, `anyOf`, and `oneOf`. This feature enables complex type relationships similar to how ClassNode implements composition, but at the property level.
