...
This document describes the comprehensive test suite for path database table functionality in Objectified. These tests cover the version_path, path_operation, path_parameter, and path_response tables that store OpenAPI/REST API path definitions.
...
- Database Schema: `/objectified-db/scripts/20260107-204300.sql`
