...
This document provides a summary of all test suites created for the Objectified database functionality.
...
- [Database Schema Scripts](../objectified-db/scripts/)
...
- Examine the database schema in `/objectified-db/scripts/`
