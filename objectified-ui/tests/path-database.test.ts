...
describe('Path Database Tables - version_path', () => {
  ...
  describe('createPath', () => {
    it('should create a new path', async () => {
      ...
      expect(mockConnectionPool.query).toHaveBeenCalledWith(
        expect.stringContaining('INSERT INTO odb.version_path'),
  ...
  describe('updatePath', () => {
    it('should update an existing path', async () => {
      ...
      expect(mockConnectionPool.query).toHaveBeenCalledWith(
        expect.stringContaining('UPDATE odb.version_path'),
  ...
  describe('deletePath', () => {
    it('should delete a path', async () => {
      ...
      expect(mockConnectionPool.query).toHaveBeenCalledWith(
        expect.stringContaining('DELETE FROM odb.version_path'),
        ['path-1']
      );
    });
