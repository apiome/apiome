...
COMMENT ON COLUMN apiome.class_properties.property_id IS 'Reference to the property definition (NULL for reference properties that are class-specific)';
...
COMMENT ON CONSTRAINT class_properties_null_property_id_is_reference ON apiome.class_properties
