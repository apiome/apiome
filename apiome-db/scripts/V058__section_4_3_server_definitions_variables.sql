...
ALTER TABLE apiome.version_server
...
COMMENT ON COLUMN apiome.version_server.variables IS 'OpenAPI Server variables: default, enum, description per variable';
COMMENT ON COLUMN apiome.version_server.environment IS 'Environment label: dev, staging, prod (for UI and x-environment)';
