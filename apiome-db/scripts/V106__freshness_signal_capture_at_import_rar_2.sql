...
--   2. The import lineage (`apiome.repository_import_spec`) now records the freshness
...
COMMENT ON COLUMN apiome.tenant_repository_files.commit_sha IS
  'Branch tip commit SHA observed by the scan that indexed this file row (RAR-2.1).';

COMMENT ON COLUMN apiome.tenant_repository_files.committed_at IS
...
COMMENT ON COLUMN apiome.repository_import_spec.last_imported_commit_sha IS
  'Branch tip commit SHA observed for this file at the time of import (RAR-2.1).';

COMMENT ON COLUMN apiome.repository_import_spec.last_imported_committed_at IS
...
COMMENT ON COLUMN apiome.repository_import_spec.last_imported_blob_sha IS
