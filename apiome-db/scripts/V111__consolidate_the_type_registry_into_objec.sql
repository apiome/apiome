-- Consolidate the type registry into apiome-db; extend apiome.primitives.
...
-- (apiome-types-db) with its own `otr` schema and type_namespace / type_definition /
...
-- lives in the existing `apiome` schema by EXTENDING the apiome.primitives table in place — one
...
-- (1.2) adds the JSON Schema 2020-12 registry columns to apiome.primitives. No new tables.
...
-- 1.2 — Extend apiome.primitives with namespace / $id / base-uri / draft / source / $ref columns.
