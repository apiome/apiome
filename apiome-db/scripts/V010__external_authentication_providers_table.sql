...
DROP TABLE IF EXISTS apiome.external_auth_providers CASCADE;
...
COMMENT ON COLUMN external_auth_providers.user_id IS 'Reference to the master user account in apiome.users';
