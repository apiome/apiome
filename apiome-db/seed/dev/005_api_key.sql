...
-- Stored as key_prefix (sk_devseed00...) + bcrypt(key) hash, exactly as apiome-rest expects.

INSERT INTO apiome.api_keys (id, tenant_id, name, description, key_hash, key_prefix)
VALUES (
