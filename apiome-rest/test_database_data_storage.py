...
def _scripts_dir() -> Path:
    """Path to apiome-db/scripts (repo root is parent of apiome-rest)."""
    this_file = Path(__file__).resolve()
    repo_root = this_file.parent.parent  # apiome-rest -> objectified-commercial
    return repo_root / 'apiome-db' / 'scripts'
