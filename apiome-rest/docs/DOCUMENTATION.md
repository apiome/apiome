# Apiome REST API - Technical Documentation

## Architecture

The Apiome REST API is built with FastAPI and follows a layered architecture:
...
```sql
-- Tenants
apiome.tenants (id, slug, name, ...)

-- Projects
apiome.projects (id, tenant_id, slug, name, ...)

-- Versions
apiome.versions (id, project_id, version_id, visibility, published, ...)

-- Classes
apiome.classes (id, version_id, name, description, schema, ...)

-- Class Properties
apiome.class_properties (id, class_id, name, description, data, ...)
```
...
logger = logging.getLogger("apiome")
