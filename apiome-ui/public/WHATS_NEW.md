...
- Export: GraphQL fidelity pack — REST HTTP method/path/status/headers are predicted as DROP when reframing to Query/Mutation fields; validation constraints approximate as custom scalars; oneOf/unions report OK when member shapes allow (MFX-13.3)
