...
export function quickLayoutSnapshotsStorageKey(versionId: string, userId: string | null): string {
  ...
  return `apiome.quickCanvasSnapshots.v${QUICK_LAYOUT_SNAPSHOTS_SCHEMA_VERSION}:${versionId}:${uid}`;
}
...
export const QUICK_LAYOUT_SHARE_KIND = 'apiome.quickLayoutSnapshotShare' as const;
