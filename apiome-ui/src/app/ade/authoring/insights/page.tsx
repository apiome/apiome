/**
 * `/ade/authoring/insights` — Insights (UXE-1.2 placeholder).
 *
...
export default function AuthoringInsightsPage() {
  return <AuthoringSurfacePlaceholder surface={getAuthoringSurface('insights')!} />;
}
