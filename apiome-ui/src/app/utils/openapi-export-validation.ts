...
export const VALIDATOR_NOTE =
  'Document structure is validated with @seriousme/openapi-schema-validator against the OpenAPI 3.2 JSON Schema, plus Apiome checks for operationId, path parameters, and local $ref targets.';
