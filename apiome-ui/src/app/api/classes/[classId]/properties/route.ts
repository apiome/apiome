/**
 * API Proxy for Class Properties Management
 *
 * Proxies requests to the REST API with JWT authentication.
 * Handles POST (add property to class) operations.
 */
...
/**
 * POST /api/classes/[classId]/properties
...
export async function POST(
  ...
  try {
    ...
    const response = await fetch(`${REST_API_BASE_URL}/classes/${tenantSlug}/${classId}/properties`, {
      method: 'POST',
      headers,
