/**
 * POST /api/projects/[projectId]/version-branches/rollback
 * Proxies to REST POST /v1/versions/{tenantSlug}/{projectId}/version-branches/rollback (#745).
 */
...
export async function POST(
  ...
  try {
    ...
    const url = `${REST_API_BASE_URL}/versions/${encodeURIComponent(tenant.slug)}/${encodeURIComponent(projectId)}/version-branches/rollback`;
