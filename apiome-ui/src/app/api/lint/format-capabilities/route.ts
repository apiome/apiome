/**
 * GET /api/lint/format-capabilities
 * Proxies to REST GET /v1/lint/format-capabilities (CLX-2.4 / #4854).
 */
...
export async function GET() {
  try {
    ...
    const response = await fetch(`${REST_API_BASE_URL}/lint/format-capabilities`, {
      method: 'GET',
