/**
 * API Proxy for single Operation CRUD
 *
 * Proxies PUT/DELETE requests to the REST API with JWT authentication.
 */
...
/**
 * PUT /api/paths/[versionId]/[pathId]/operations/[operationId]
 * Update an operation
 */
export async function PUT(
  request: NextRequest,
  { params }: { params: Promise<{ versionId: string; pathId: string; operationId: string }> }
) {
  try {
    const { versionId, pathId, operationId } = await params;
    ...
    const response = await fetch(
      `${REST_API_BASE_URL}/paths/${tenant.slug}/${versionId}/${pathId}/operations/${operationId}`,
      {
        method: 'PUT',
        headers,
...
/**
 * DELETE /api/paths/[versionId]/[pathId]/operations/[operationId]
 * Delete an operation
 */
