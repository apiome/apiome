/**
 * API Proxy for full Path data
 *
 * Proxies GET request for full path with all operation details.
 */
...
/**
 * GET /api/paths/[versionId]/[pathId]/full
 * Get a path with full operation details
 */
export async function GET(
  ...
  try {
    ...
    const response = await fetch(`${REST_API_BASE_URL}/paths/${tenant.slug}/${versionId}/${pathId}/full`, {
      method: 'GET',
      headers,
    });
