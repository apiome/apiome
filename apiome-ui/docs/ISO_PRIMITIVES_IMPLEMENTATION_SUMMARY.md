...
### 1. Migration File
**Location**: `/Users/kenji/Development/apiome/apiome-db/scripts/20260124-140000.sql`
...
**Location**: `/Users/kenji/Development/apiome/ISO_PRIMITIVES_PRELOAD.md`
...
### 3. Test File
**Location**: `/Users/kenji/Development/apiome/apiome-rest/test_iso_primitives_preload.py`
...
### View by Category
```sql
SELECT category, COUNT(*) FROM apiome.primitives 
...
FROM apiome.primitives WHERE is_system = true 
