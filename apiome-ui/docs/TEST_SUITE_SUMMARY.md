...
**File:** `apiome-db/scripts/test_shared_path_responses_migration.sql`  
...
**How to Run:**
```bash
psql -U postgres -d apiome_test -f apiome-db/scripts/test_shared_path_responses_migration.sql
```
...
**File:** `apiome-ui/tests/db/helper-shared-path-responses.test.ts`  
...
**File:** `apiome-ui/tests/components/PathResponseNode.test.tsx` (removed)  
...
**File:** `apiome-ui/tests/components/OperationPropertiesPanel-responses.test.tsx` (removed)  
...
**File:** `apiome-ui/tests/integration/paths-canvas-response-linking.test.tsx` (removed)  
...
**File:** `apiome-ui/tests/e2e/SHARED_RESPONSES_E2E_PLAN.md`  
...
**File:** `apiome-ui/tests/SHARED_RESPONSES_TESTS_README.md`  
**Lines:** 243  
...
**File:** `apiome-ui/tests/components/OperationPropertiesPanel-responses.test.tsx`  
...
**File:** `apiome-ui/tests/integration/paths-canvas-response-linking.test.tsx`  
...
### Created
1. `apiome-db/scripts/test_shared_path_responses_migration.sql`
2. `apiome-ui/tests/db/helper-shared-path-responses.test.ts`
3. `apiome-ui/tests/components/PathResponseNode.test.tsx`
4. `apiome-ui/tests/components/OperationPropertiesPanel-responses.test.tsx`
5. `apiome-ui/tests/integration/paths-canvas-response_linking.test.tsx`
6. `apiome-ui/tests/e2e/SHARED_RESPONSES_E2E_PLAN.md`
7. `apiome-ui/tests/SHARED_RESPONSES_TESTS_README.md`

### Modified
1. `apiome-ui/package.json` - Added test scripts
...
Comprehensive test suites for various features of the Apiome platform.
...
**File:** `apiome-ui/tests/utils/graphql.test.ts`  
